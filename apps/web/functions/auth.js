  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .mark-primary {
      ...
      animation: mark-primary-in .4s cubic-bezier(.2, .9, .3, 1.25) .62s forwards;
    }
    ...
    .mark-secondary {
      ...
      animation: mark-secondary-in .45s cubic-bezier(.2, .85, .25, 1.15) .76s forwards;
    }
