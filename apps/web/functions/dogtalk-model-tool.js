...
export const DOGTALK_MODEL_TOOL = Object.freeze({
  ...
  function: {
    ...
    description: '低频读取当前聊天窗口里“屋主 · 人类思考链”。当前只有屋主明确选择“这次希望另一位屋主直接读一下”时可读一次；“另一位屋主困惑时可以看一点”暂时只是 dormant 许可，不会自动触发。它不是行为指令、长期偏好、记忆、种子或心理评估，当前正文与边界句永远优先。',
    parameters: {
      type: 'object',
