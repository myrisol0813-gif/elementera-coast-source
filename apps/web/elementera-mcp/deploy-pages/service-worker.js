...
const CACHE_NAME = 'elementera-coast-source-app-01';
const CORE = Object.freeze([
  '/',
  '/index.html',
  '/manifest.json',
  '/public/styles/tokens.css?v=coast-source-app-01',
  '/public/styles/shell.css?v=coast-source-app-01',
  '/public/styles/chat.css?v=coast-source-app-01',
  '/public/styles/mcp-letter.css?v=coast-source-app-01',
  '/public/styles/rikkahub.css?v=coast-source-app-01',
  '/public/styles/features.css?v=coast-source-app-01',
  '/public/styles/cross-window.css',
  '/public/styles/desk.css?v=coast-source-app-01',
  '/public/styles/dev-hands.css?v=coast-source-app-01',
  '/public/styles/daily.css',
  '/public/styles/model-metadata.css',
  '/public/app.js?v=coast-source-app-01',
  '/public/core/api.js',
