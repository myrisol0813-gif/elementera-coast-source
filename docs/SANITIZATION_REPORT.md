...
- Approved visual changes are limited to the home mark, private logo/avatar family, mailbox private illustration removal, and former private utility marks.
- The agreed private proper-name scan is clean in the current tree. Legacy/product/internal identifiers may remain where they are intentional compatibility keys or explicitly pending review; git history, release artifacts, and binary visual checks are tracked separately.
